<?php
	...
	echo '<form action="ae_doc.php" method="POST" enctype="multipart/form-data">';
	
	echo '<fieldset><legend>ACTUALIZAR DOCUMENTOS REMITIDOS</legend>';
	
	echo 'Num REGISTRO : <input type="text" name="n_reg" size="10" readonly/>&nbsp &nbsp &nbsp
	 FECHA EMISION : <input type="text" name="fecha_emi" size="10" readonly/></br>
	 ...
	 DESTINATARIO : <input type="text" name="nombre_dest" size="50" readonly/></br>
	...
	echo '<p><input type="submit" name="enviar" value="ACTUALIZAR" /></p>';
